...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_h.C_INT.withName("__lock"),
        curl_h.C_INT.withName("__count"),
        curl_h.C_INT.withName("__owner"),
        curl_h.C_INT.withName("__nusers"),
        curl_h.C_INT.withName("__kind"),
        curl_h.C_SHORT.withName("__spins"),
        curl_h.C_SHORT.withName("__elision"),
