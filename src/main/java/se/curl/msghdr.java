...
public class msghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_h.C_POINTER.withName("msg_name"),
        curl_h.C_INT.withName("msg_namelen"),
        MemoryLayout.paddingLayout(4),
        curl_h.C_POINTER.withName("msg_iov"),
        curl_h.C_LONG.withName("msg_iovlen"),
        curl_h.C_POINTER.withName("msg_control"),
        curl_h.C_LONG.withName("msg_controllen"),
        curl_h.C_INT.withName("msg_flags"),
        MemoryLayout.paddingLayout(4)
    ).withName("msghdr");
