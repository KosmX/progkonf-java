...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        curl_h.C_INT.withName("tm_sec"),
        curl_h.C_INT.withName("tm_min"),
        curl_h.C_INT.withName("tm_hour"),
        curl_h.C_INT.withName("tm_mday"),
        curl_h.C_INT.withName("tm_mon"),
        curl_h.C_INT.withName("tm_year"),
        curl_h.C_INT.withName("tm_wday"),
        curl_h.C_INT.withName("tm_yday"),
        curl_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        curl_h.C_LONG.withName("tm_gmtoff"),
        curl_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
